...
@section('title', 'Page Add Sparepart Item')
    ...
    <header class="qn-header z-1 sticky-top p-md-3 py-3 px-xl-5 bg-white">
        <div class="container-fluid d-grid d-flex justify-content-between align-items-center position-relative">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('sparepart-item.index', ['jenis_sparepart_id' => $jenisSparepart->id]) }}"
                    class="btn btn-close" aria-label="Kembali ke halaman list"></a>
                <span class="m-0 fs-6 fw-medium">Tambahkan Data Sparepart</span>
            </div>
        ...
        <div class="container-fluid p-0">
            <div class="w-100 p-2 bg-white">
                <div class="w-100 p-2 py-md-3 py-xl-4 rounded-4 bg-body-tertiary">
                    ...
                    <form method="POST" action="{{ route('sparepart-item.store') }}" id="advancedForm"
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 g-3">
                                        <div class="col-md-12">
                                            <div class="d-flex flex-column gap-1 mb-2">
                                                <h1 class="fs-5 fw-medium mb-0">Data Sparepart atau Aksesoris</h1>
                                                <p class="fs-6 fw-medium text-secondary mb-0">
                                                    Tambahkan data sparepart atau aksesoris.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <label for="jenisSparepart" class="form-label">
                                                Jenis Sparepart
                                                <span class="text-danger">*</span>
                                            </label>
                                            <!-- Disabled input for displaying the name -->
                                            <input type="text" class="form-control" id="jenisSparepart"
                                                value="{{ $jenisSparepart->jenis_sparepart ?? old('jenis_sparepart') }}"
                                                disabled />

                                            <!-- Hidden input to store the ID of jenis sparepart -->
                                            <input type="hidden" name="jenis_sparepart_id"
                                                value="{{ $jenisSparepart->id ?? old('jenis_sparepart_id') }}">
                                        </div>
                                        <div class="col-md-12">
                                            <label for="namaSparepart" class="form-label">
                                                Nama Sparepart
                                                <span class="text-danger">*</span>
                                            </label>
                                            <input type="text" class="form-control" id="namaSparepart"
                                                name="nama_sparepart" placeholder="Masukkan nama sparepart. Contoh: RAM 8GB"

...
<main class="qn-main bg-body-tertiary d-flex flex-column">
    ...
    <div class="container">
        <div class="row row-cols-1 gy-3 p-3 p-lg-4">
            ...
            <div class="d-flex flex-column gap-2">
              <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb mb-1">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('network-aset.index')}}">Data Network Aset</a></li>
          ...
          <div class="card shadow-sm border-0 rounded-4 p-2"> <!-- Gunakan p-4 agar padding seragam -->
            ...
            <div class="card-header d-flex gap-2 align-items-center justify-content-between flex-wrap bg-white border-light-subtle px-3 py-3 rounded-top-4 border-2">
                ...
                <a href="{{ route('network-aset.edit', $aset->id) }}" class="btn btn-light ms-auto">
                ...
                <div class="row gy-4 align-items-start">
                    ...
                    <div class="col-lg-4 d-flex justify-content-start">
                        <div class="text-center w-100">
                            ...
                            @if($aset->aset->gambar_aset)
                                <img
                                    src="{{ asset('storage/' . $aset->aset->gambar_aset) }}"
                                    alt="Gambar Aset"
                    ...
                    <div class="col-lg-8">
                        <div class="row gy-3">
                            ...
                            <div class="col-md-6">
                                <span class="text-muted">Mac Address Perangkat</span>
                                <div>{{ $aset->mac_address_perangkat ?? '-' }}</div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <span class="text-muted">Heirarchi Perangkat</span>
                                <div>{{ $aset->heirarchi_perangkat ?? '-' }}</div>
                            </div>
                            <div class="col-md-6">
    ...
    <div class="card shadow-sm border-0 rounded-4">
        <div class="card-body">
            ...
            <div class="row mt-4 d-flex align-items-center justify-content-between gap-2">
                <div class="col-md-3">
                    <input
                        type="text"
                        class="form-control"
                    ...
                    <tbody>
                        @foreach ($historyLokasiAsets as $history)
                            <tr>
                                ...
                                <td>{{ \Carbon\Carbon::parse($history->aset->created_at)->format('d/m/Y H:i:s') }}</td>

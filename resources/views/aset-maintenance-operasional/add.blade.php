        ...
        <div class="container-fluid p-0">
            <div class="w-100 p-2 bg-white">
                <div class="w-100 bg-body-tertiary rounded-4 p-2 py-md-3 py-xl-4 pb-5">
                    <form method="POST" action="{{ route('aset-maintenance-operasional.store') }}" id="advancedForm"
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 g-3">
                                            ...
                                            <div class="row g-2 px-3">
                                                <div class="form-check col-md-4">
                                                    <input
                                                        ...
                                                        value="perbaikan"
                                                        {{ old('jenis_pemeliharaan') == 'Perbaikan' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check col-md-4">
                                                    <input
                                                        ...
                                                        value="perawatan"
                                                        {{ old('jenis_pemeliharaan') == 'Perawatan' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check col-md-4">
                                                    <input
                                                        ...
                                                        value="pergantian"
                                                        {{ old('jenis_pemeliharaan') == 'Pergantian' ? 'checked' : '' }}>
                                            ...
                                            <div class="row g-2 px-3">
                                                <div class="form-check col-md-4">
                                                    <input
                                                        ...
                                                        value="on_progress"
                                                        {{ old('status_pemeliharaan') == 'Perawatan' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check col-md-4">
                                                    <input
                                                        ...
                                                        value="perbaikan"
                                                        {{ old('status_pemeliharaan') == 'Perbaikan' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check col-md-4">
                                                    <input
                                                        ...
                                                        value="selesai"
                                                        {{ old('status_pemeliharaan') == 'Selesai' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="deskripsi_permasalahan" id="deskripsi_permasalahan" rows="3"
                                                ...
                                                placeholder="Masukkan Deskripsi Permasalahan">{{ old('keterangan') }}</textarea>

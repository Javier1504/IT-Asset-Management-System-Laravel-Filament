...
@section('title', 'Page Edit Lokasi')
...
<header class="qn-header z-1 sticky-top p-md-3 py-3 px-xl-5 bg-white">
    <div class="container-fluid d-grid d-flex justify-content-between align-items-center position-relative">
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="m-0 fs-6 fw-medium">Edit Lokasi</span>
        </div>
    ...
    <div class="container-fluid p-0">
        <div class="w-100 p-2 bg-white">
            <div class="w-100 p-2 py-md-3 py-xl-4 rounded-4 bg-body-tertiary">
                ...
                <form method="POST" action="{{ route('location.update', $lokasi->id) }}" id="advancedForm" class="qn-form w-100 position-relative">
                    @csrf
                    @method('PUT')
                                ...
                                <div class="row row-cols-1 row-cols-md-2 g-3">
                                    <div class="col-md-12">
                                        <div class="d-flex flex-column gap-1 mb-2">
                                            <h1 class="fs-5 fw-medium mb-0">Edit Data Lokasi</h1>

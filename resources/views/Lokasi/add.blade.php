...
<header class="qn-header z-1 sticky-top p-md-3 py-3 px-xl-5 bg-white">
    <div class="container-fluid d-grid d-flex justify-content-between align-items-center position-relative">
        <div class="d-flex align-items-center gap-3">
            <a href="{{ route('location.index') }}" class="btn btn-close" aria-label="Kembali ke halaman list"></a>
            <span class="m-0 fs-6 fw-medium">Tambahkan Lokasi</span>
        </div>
    ...
    <div class="container-fluid p-0">
        <div class="w-100 p-2 bg-white">
            <div class="w-100 p-2 py-md-3 py-xl-4 rounded-4 bg-body-tertiary">
                ...
                <form method="POST" action="{{ route('location.store') }}" id="advancedForm" class="qn-form w-100 position-relative">
                    @csrf
                                ...
                                <div class="row row-cols-1 row-cols-md-2 g-3">
                                    <div class="col-md-12">
                                        <div class="d-flex flex-column gap-1 mb-2">
                                            <h1 class="fs-5 fw-medium mb-0">Data Lokasi</h1>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="inputLokasi" name="lokasi" placeholder="Masukkan Lokasi" value="{{ old('lokasi') }}" required />
                                    </div> 
                                </div>
                            </div>
                        </div>

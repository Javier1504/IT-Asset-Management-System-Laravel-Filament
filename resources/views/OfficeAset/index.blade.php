...
@section('title', 'Page All Office Aset')
        ...
        <div class="container">
            <div class="row row-cols-1 gy-3 p-3 p-lg-4">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                            <ol class="breadcrumb mb-1">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Data Office Aset</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body">
                        <h4 class="m-0">Data Office Aset</h4>
                        <form action="{{ route('office-aset.index') }}" method="GET" id="filterForm">
                            <div class="row mt-4">
                        ...
                        <div class="row mb-3">
                            <div class="col d-flex flex-wrap justify-content-end gap-2">
                                @can('akses-admin-superadmin')
                                    <a href="{{ route('office-aset.download-template') }}"
                                ...
                                @can('akses-admin-superadmin-finance')
                                    <a href="{{ route('office-aset.export', request()->query()) }}" class="btn btn-success">
                                        <i class="sym sym-file-download-02 me-1"></i> Export Excel
                                    </a>
                                @endcan

                                @can('akses-admin-superadmin')
                                    <a href="{{ route('office-aset.create') }}"
                        ...
                        <div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('office-aset.import-template') }}" method="POST"
                        ...
                        <div class="table-responsive mt-4">
                            <table class="table table-bordered align-middle">
                                ...
                                <tbody>
                                    @foreach ($officeAsets as $aset)
                                        <tr>
                                            <td>{{ ($officeAsets->currentPage() - 1) * $officeAsets->perPage() + $loop->iteration }}
                                            </td>
                                                ...
                                                <div class="d-flex align-items-center justify-content-end gap-1">
                                                    ...
                                                    @can('akses-admin-superadmin')
                                                        ...
                                                        <form id="delete-form-{{ $aset->id }}"
                                                            action="{{ route('office-aset.destroy', $aset->id) }}"
                        ...
                        <div
                            ...
                            <p class="text-dark m-0">
                                Menampilkan
                                <span class="fw-bold">{{ $officeAsets->firstItem() }}</span> -
                                <span class="fw-bold">{{ $officeAsets->lastItem() }}</span>
                                dari Total <span class="fw-bold">{{ $officeAsets->total() }}</span> data
                            </p>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-end mb-0">
                                    ...
                                    <!-- Tombol Sebelumnya -->
                                    <li class="page-item {{ $officeAsets->onFirstPage() ? 'disabled' : '' }}">
                                        <a class="page-link" href="{{ $officeAsets->previousPageUrl() }}">
                                    ...
                                    <!-- Nomor halaman -->
                                    @php
                                        $currentPage = $officeAsets->currentPage();
                                        $lastPage = $officeAsets->lastPage();
                                    @endphp

                                    @for ($page = 1; $page <= 3 && $page <= $lastPage; $page++)
                                        <li class="page-item {{ $currentPage == $page ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $officeAsets->url($page) }}">
                                                {{ $page }}
                                            </a>
                                        </li>
                                    @endfor
                                    ...
                                    @if ($lastPage > 3)
                                        <li class="page-item {{ $currentPage == $lastPage ? 'active' : '' }}">
                                            <a class="page-link" href="{{ $officeAsets->url($lastPage) }}">
                                                {{ $lastPage }}
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    <!-- Tombol Selanjutnya -->
                                    <li class="page-item {{ $officeAsets->onLastPage() ? 'disabled' : '' }}">
                                        <a class="page-link" href="{{ $officeAsets->nextPageUrl() }}">

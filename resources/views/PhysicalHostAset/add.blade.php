...
@section('title', 'Page Add Physical Host Aset')
        ...
        <div class="container-fluid p-0">
            <div class="w-100 p-2 bg-white">
                <div class="w-100 bg-body-tertiary rounded-4 p-2 py-md-3 py-xl-4 pb-5">
                    <form method="POST" action="{{ route('physical-host-aset.store') }}" id="advancedForm"
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 g-3">
                                        <div class="col-md-12">
                                            <div class="d-flex flex-column gap-1 mb-2">
                                                <h1 class="fs-5 fw-medium mb-0">Data Physical Host Aset</h1>
                                                <p class="fs-6 fw-medium text-secondary mb-0">
                                                    Pilih dan masukkan data aset Physical Host.
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="inputNamaPerangkat"
                                                name="nama_perangkat" placeholder="Masukkan nama perangkat"
                                                value="{{ old('nama_perangkat') }}" required />
                                        </div>
                                        @can('super_admin')
                                            <div class="col-md-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="heirarchi_perangkat" name="heirarchi_perangkat">
                                                ...
                                                <option value="core"
                                                    {{ old('heirarchi_perangkat') == 'core' ? 'selected' : '' }}>Core
                                                </option>
                                                <option value="distribution"
                                                    {{ old('heirarchi_perangkat') == 'distribution' ? 'selected' : '' }}>
                                                    Distribution</option>
                                                <option value="management"
                                                    {{ old('heirarchi_perangkat') == 'management' ? 'selected' : '' }}>
                                                    Management</option>
                                                <option value="access"
                                                    {{ old('heirarchi_perangkat') == 'access' ? 'selected' : '' }}>Access
                                                </option>
                                                <option value="endpoint"
                                                    {{ old('heirarchi_perangkat') == 'endpoint' ? 'selected' : '' }}>
                                                    Endpoint</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12">

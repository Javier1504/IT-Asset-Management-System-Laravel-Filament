...
@section('title', 'Edit Template Penomoran')
...
@section('content')
    ...
    <header class="qn-header z-1 sticky-top p-md-3 py-3 px-xl-5 bg-white">
        <div class="container-fluid d-grid d-flex justify-content-between align-items-center position-relative">
            <div class="d-flex align-items-center gap-3">
                ...
                <span class="m-0 fs-6 fw-medium">Edit Template Penomoran</span>
            </div>
    ...
    <main class="qn-main bg-body-tertiary d-flex flex-column">
        ...
        <div class="container-fluid p-0">
            <div class="w-100 p-2 bg-white">
                <div class="w-100 p-2 py-md-3 py-xl-4 rounded-4 bg-body-tertiary">
                    ...
                    <form method="POST" action="{{ route('numbering-template.update', $numberingTemplate->id) }}"
                        id="editForm" class="qn-form w-100 position-relative">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 g-3">
                                        <div class="col-md-12">
                                            <div class="d-flex flex-column gap-1 mb-2">
                                                <h1 class="fs-5 fw-medium mb-0">Edit Template Penomoran</h1>
                                                <p class="fs-6 fw-medium text-secondary mb-0">
                                                    Perbarui informasi template penomoran dokumen.
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="module" name="module"
                                                ...
                                                list="document-model-options"
                                                value="{{ old('module', $numberingTemplate->module) }}" required />
                                            ...
                                            <select class="form-select" id="company_id" name="company_id" required>
                                                ...
                                                @foreach ($companies as $company)
                                                    <option value="{{ $company->id }}"
                                                        {{ old('company_id', $numberingTemplate->company_id) == $company->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="reset_type" name="reset_type" required>
                                                <option value="" disabled>Pilih Tipe Reset</option>
                                                <option value="yearly"
                                                    {{ old('reset_type', $numberingTemplate->reset_type) == 'yearly' ? 'selected' : '' }}>
                                                    Tahunan (Reset setiap tahun)
                                                </option>
                                                <option value="monthly"
                                                    {{ old('reset_type', $numberingTemplate->reset_type) == 'monthly' ? 'selected' : '' }}>
                                                    Bulanan (Reset setiap bulan)
                                                </option>
                                                <option value="none"
                                                    {{ old('reset_type', $numberingTemplate->reset_type) == 'none' ? 'selected' : '' }}>
                                                    Tidak Reset
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="no_template" name="no_template"
                                                placeholder="e.g., 035/TMP.RO.BRT/TIS/SVM"
                                                value="{{ old('no_template', $numberingTemplate->no_template) }}"
                                                required />
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="no_sop" name="no_sop"
                                                placeholder="e.g., 001/PO.SOP/TIS/SVM"
                                                value="{{ old('no_sop', $numberingTemplate->no_sop) }}" required />
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="no_version" name="no_version"
                                                placeholder="e.g., 1.0 - 2025.07.10"
                                                value="{{ old('no_version', $numberingTemplate->no_version) }}" required />
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="format" name="format"
                                                ...
                                                value="{{ old('format', $numberingTemplate->format) }}" required />
        ...
        <div class="qn-fab d-md-none" role="group" aria-label="FAB Group">
            <button type="submit" class="btn btn-primary btn-lg rounded-pill shadow-lg" form="editForm">

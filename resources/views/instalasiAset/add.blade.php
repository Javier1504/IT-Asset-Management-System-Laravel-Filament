    ...
    <header class="qn-header z-1 sticky-top p-md-3 py-3 px-xl-5 bg-white">
        <div class="container-fluid d-grid d-flex justify-content-between align-items-center position-relative">
            <div class="d-flex align-items-center gap-3">
                ...
                <span class="m-0 fs-6 fw-medium">Formulir Instalasi Aset</span>
            </div>
        ...
        <div class="container-fluid p-0">
            <div class="w-100 p-2 bg-white">
                <div class="w-100 bg-body-tertiary rounded-4 p-2 py-md-3 py-xl-4 pb-5">
                    <form method="POST" action="{{ route('instalasi-aset.store') }}" id="advancedForm"
                                ...
                                <div class="card-body p-3 px-md-4 p-xl-4 px-xl-5">
                                    <div class="row row-cols-1 row-cols-md-2 g-3">
                                            ...
                                            <select name="ba_pengembalian_id" id="ba_pengembalian_id"
                                                ...
                                                @foreach ($baPengembalian as $item)
                                                    <option value="{{ $item->id }}"
                                                        ...
                                                        {{ old('ba_pengembalian_id') == $item->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="aset_id" id="hiddenAsetId" value="{{ old('aset_id') }}">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="os_sebelumnya"
                                                ...
                                                value="{{ old('os_sebelumnya') }}" required />
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" id="daftar_aplikasi_ilegal_text"
                                                ...
                                                value="{{ old('daftar_aplikasi_ilegal_text') }}">
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row g-3">
                                                <div class="col-md-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="reset_sistem_operasi_windows" value="1" id="os_windows"
                                                            {{ old('reset_sistem_operasi_windows') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            name="reset_sistem_operasi_linux" value="1" id="os_linux"
                                                            {{ old('reset_sistem_operasi_linux') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="os_macos"
                                                            {{ old('reset_sistem_operasi_macos') ? 'checked' : '' }}>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            {{ is_array(old('instalasi_antimalware')) && in_array('Windows Security', old('instalasi_antimalware')) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            {{ is_array(old('instalasi_antimalware')) && in_array('Windows Firewall', old('instalasi_antimalware')) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            {{ is_array(old('instalasi_antimalware')) && in_array('Clamav', old('instalasi_antimalware')) ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox"
                                                            ...
                                                            id="am_lainnya"
                                                            {{ old('instalasi_antimalware_lainnya') ? 'checked' : '' }}>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('instalasi_antimalware_lainnya_text') }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('aplikasi_terpasang_text') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('aplikasi_tambahan_text') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
